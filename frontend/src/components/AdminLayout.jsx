...
import { LayoutDashboard, Package, ShoppingCart, Truck, Users, Sparkles, LogOut, Store, GraduationCap } from "lucide-react";
...
export default function AdminLayout() {
  ...
  return (
    <div className="min-h-screen grid md:grid-cols-[260px_1fr]" style={{ background: "#F7F5F2" }}>
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 grid grid-cols-7 border-t bg-white" style={{ borderColor: "var(--gs-border)" }}>
        {NAV.map((n) => (
