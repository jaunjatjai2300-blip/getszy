      ...
      <section className="relative overflow-hidden">
        ...
        <div className="gs-container relative grid lg:grid-cols-2 gap-10 py-12 lg:py-20 items-center">
          <div>
            ...
            <p className="mt-6 text-base sm:text-lg text-[var(--gs-muted)] max-w-xl">Fashion, beauty, kids, home + powerful digital tools. Admin dashboard with AI commands — type what you want, getszy does it.</p>
