...
CATEGORIES = [
    ...
    {'name': 'Beauty', 'slug': 'beauty', 'image': 'https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=800'},
...
PRODUCTS = [
    ...
    {'name': 'Matte Lipstick Set (5)', 'price': 999, 'cost_price': 350, 'stock': 35, 'category': 'beauty', 'supplier': 'Mumbai Beauty Co',
     'images': ['https://images.unsplash.com/photo-1586495777744-4413f21062fa?w=800'], 'description': 'Long-lasting matte lipsticks in 5 must-have shades.'},
    {'name': 'Ceramic Vase Set', 'price': 1199, 'cost_price': 480, 'stock': 22, 'category': 'home-decor', 'supplier': 'Surat Textiles',
     'images': ['https://images.unsplash.com/photo-1578500494198-246f612d3b3d?w=800'], 'description': 'Hand-crafted ceramic vases — a trio of elegance.'},
